	...
	// 1. Put all of the game code inside the main method (below)
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// 13. If the user's health is less than or equal to 0
				if (playerHealth<=0) {
					JOptionPane.showMessageDialog(null, "YOU LOST! OOF OOF LUCAS IS POOPY FOR REAL");
				}
			// -- Tell the user that they lost
			// 14. Else if the dragon's health is less than or equal to 0
				else if (dragonHealth<=0) {
					JOptionPane.showMessageDialog(null, "The dragon is dead and you took a ton of gold! It's almost heavier than Lucas!");
				}
			...
			// each player this round)
					...
					JOptionPane.showMessageDialog(null, "You have "+playerHealth+" health left. You took "+playerDamage+" damage.");
					JOptionPane.showMessageDialog(null, "The dragon has "+dragonHealth+" health left. It took "+dragonDamage+" damage.");
				}
